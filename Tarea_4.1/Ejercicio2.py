...
# === OPCIONES PARA VER BIEN LA TABLA ===
...
plt.xlabel("x")
plt.ylabel("Derivada")
plt.title("Ejercicio 2: Comparación de derivadas")
plt.legend()
plt.grid()
plt.show()
...
plt.title("Ejercicio 2: Errores numéricos")
plt.legend()
plt.grid()
plt.show()

# === GUARDAR TABLA (OPCIONAL, RECOMENDADO) ===
tabla.to_excel("Ejercicio2_tabla.xlsx", index=False)